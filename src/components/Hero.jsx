...
const HeroSection = () => {
  ...
  return (
    <div className="tw-relative tw-min-h-screen tw-bg-background tw-text-text tw-overflow-hidden tw-flex tw-flex-col">
      <AnimatePresence>
        <motion.div
      ...
      <div className="tw-container tw-mx-auto tw-px-6 sm:tw-px-8 md:tw-px-16 tw-relative tw-z-20 tw-flex tw-flex-1 tw-items-center tw-justify-center">
        <motion.div
