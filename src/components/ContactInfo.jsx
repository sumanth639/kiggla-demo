...
const ContactInfo = () => {
  return (
    <div className="tw-w-full lg:tw-w-2/5 tw-flex tw-flex-col tw-justify-center tw-space-y-8">
      <div className="tw-space-y-6 tw-text-center md:tw-text-left">
        <motion.span
          className="tw-text-sm tw-font-bold tw-text-center tw-uppercase tw-tracking-widest tw-text-primary tw-block"
        ...
        <motion.h2
          className="tw-mt-3 tw-text-3xl tw-text-center md:tw-text-4xl tw-font-bold tw-text-text"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.5 }}
        ...
        <p className="tw-text-base tw-text-center md:tw-text-lg tw-text-muted tw-leading-relaxed">
